...
public class PersistenceTest {
    ...
    public static void setupDatabase() throws Exception {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.execute("CREATE TABLE users (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(50) UNIQUE, password_hash VARCHAR(255))");
            stmt.execute("CREATE TABLE rankings (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT, score INT)");
        }
    }
